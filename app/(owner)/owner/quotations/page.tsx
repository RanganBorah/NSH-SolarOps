...
export default function OwnerQuotationsPage() {
  ...
  const handleSaveQuotation = () => {
    ...
    const baseData = {
      quotationNo: existing?.quotationNo || generateQuotationNumber(quotations.length),
      date,
      toWhom: toWhom.trim(),
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
        ...
        <div className="mt-6 rounded-2xl border border-slate-800 bg-slate-950 p-4">
          ...
          <div className="hidden md:grid md:grid-cols-12 md:gap-4 rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-slate-300">
